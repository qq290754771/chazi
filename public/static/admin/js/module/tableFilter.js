					...
					if(filterType == "checkbox"){
						...
						if(!filterUrl){
							layui.each(filterData, function(i, item){
								filterBox.find('ul').append('<li><input type="checkbox" name="'+filterName+'['+item.value+']" value="'+item.value+'" title="'+item.name+'" lay-skin="primary"></li>');
							})
						}
					}
					if(filterType == "radio"){
						...
						if(!filterUrl){
							...
							layui.each(filterData, function(i, item){
								filterBox.find('ul').append('<li><input type="radio" name="'+filterName+'" value="'+item.value+'" title="'+item.name+'"></li>');
							})
						}
					}
					if(filterType == "date"){
					...
					if((filterType == 'checkbox' || filterType == 'radio') && filterUrl){
						...
						$.getJSON(filterUrl + "?_t=" + new Date().getTime(), function(res, status, xhr){
							...
							layui.each(res.data, function(i, item){
								filterType == "checkbox" && filterBoxUl.append('<li><input type="checkbox" name="'+filterName+'['+item.value+']" value="'+item.value+'" title="'+item.name+'" lay-skin="primary"></li>');
								filterType == "radio" && filterBoxUl.append('<li><input type="radio" name="'+filterName+'" value="'+item.value+'" title="'+item.name+'"></li>');
							})
							form.render(null, 'table-filter-form');
							form.val("table-filter-form", tableFilter.toLayuiFrom(elemId, filterName, filterType));
						});
